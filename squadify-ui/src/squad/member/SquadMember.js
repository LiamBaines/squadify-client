  ...
  render() {
    return (
      <div className="panel-block p-0 m-0">
        ...
        {(this.props.type === "pending" && this.props.isPrimary) ? <SquadMemberPendingButtons manageSquadMembers={this.props.manageSquadMembers} user={this.props.user}/> : null}
        {(this.props.type !== "pending" && this.props.isPrimary) ? <SquadMemberRemoveButton manageSquadMembers={this.props.manageSquadMembers} user={this.props.user}/> : null}
        </div>
      </div>
    </div>
    )
